...
res.redirect("https://t.me/TrackDownPH");
}
...
if(msg?.reply_to_message?.text=="Type Or Paste Your URL"){
...
\n\nThe project is OSS at: https://github.com/MdSagorMunshi/TrackDown
`);
}
...
bot.sendMessage(cid,`Type or Paste Your URL`,mk);
}
